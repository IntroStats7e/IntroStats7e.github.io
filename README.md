...
See the [index](https://github.com/IntroStats7e/IntroStats7e.github.io/blob/main/data_index.csv) for a list of the available datasets and some basic information about each dataset.
