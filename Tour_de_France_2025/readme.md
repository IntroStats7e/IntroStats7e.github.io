...
---|---------
`Year` | Year of race
`Winner` | Cyclist who won the race
`Country` | Winning cyclist's country
`Age` | Winning cyclist's age (years)
`Team` | Winning cyclist's team
`Total.Time.h.min.sec.` | Race time in format hh.mm.ss
`Total.Time.h.` | Race time in hours
`Average.Speed` | Average speed (kilometers per hour) of winning cyclist
`Stages` | Number of race stages in that year's Tour de France
`Distance.km` | Total distance of race (km)
